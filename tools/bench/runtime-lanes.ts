...
const lanes: Record<BenchmarkLaneId, BenchmarkLane> = {
  "hermes-baseline": {
    ...
    requiredCapabilities: [
      ...
      "same strict RN benchmark case contract, checksum, and app source as every strict comparison lane",
    ],
  ...
  "hermes-iris-bridge": {
    ...
    requiredCapabilities: [
      ...
      "same RN benchmark suite, strict case contract, and checksum as hermes-baseline",
    ],
  ...
  "quickjs-iris-bridge": {
    ...
    requiredCapabilities: [
      ...
      "same RN benchmark suite, strict case contract, and checksum as hermes-baseline before strict ratios are allowed",
    ],
